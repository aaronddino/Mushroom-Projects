                ...
                itemBuilder: (BuildContext context, int index){
                  return new Container(
                    child: new Column(
                      children: <Widget>[
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Bangalow_Palm.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Bangalow_Palm.jpg";
                            globals.displayspecies.speicesname = "Archontophoenix cunninghamiana";
                            globals.displayspecies.commoname = "Bangalow Palm";
                            globals.displayspecies.description = "A tall palm with bright red berries, similar to the Alexandra Palm. This is the only palm tree native to the Redlands mainland.";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Blueberry_Ash.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Blueberry_Ash.jpg";
                            globals.displayspecies.speicesname = "Elaeocarpus reticulatus";
                            globals.displayspecies.commoname = "Blueberry Ash";
                            globals.displayspecies.description = "An attractive tree that can be pruned to shape. Bears lots of small, bell shaped flowers and bright blue fruits. Grows to six metres tall.";
                            globals.displayspecies.image1 = "assets/Blueberry_Ash_1.jpg";
                            globals.displayspecies.image2 = "assets/Blueberry_Ash_2.jpg";
                            globals.displayspecies.image3 = "assets/Blueberry_Ash_3.jpg";
                            Navigator.of(context).pushNamed("/speciesinfo");
                          },
                        ),
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Broad_leaf_paperbark.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Broad_leaf_paperbark.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Brush_Box.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Brush_Box.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Coastal_Banksia.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Coastal_Banksia.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Eprapah_Wattle.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Eprapah_Wattle.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Forest_She_oak.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Forest_She_oak.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Grey_Myrtle.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Grey_Myrtle.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Macaranga.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Macaranga.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Native_Frangipani.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Native_Frangipani.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Native_Mulberry_Tree_1.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Native_Mulberry_Tree_1.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Pink_Euodia.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Pink_Euodia.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Pink_Tips_Bottlebrush.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Pink_Tips_Bottlebrush.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Plunkett_Mallee.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Plunkett_Mallee.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Scribbly_Gum.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Scribbly_Gum.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Small_leafed_lilly_pilly.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Small_leafed_lilly_pilly.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Tallowwood.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Tallowwood.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Water_Gum.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Water_Gum.jpg";
                        ...
                        new RaisedButton(
                          child: new Image(image: new AssetImage("assets/Wheel_of_Fire.jpg"), height: 200.0, width: 500.0),
                          onPressed: (){
                            globals.displayspecies.mainImage = "assets/Wheel_of_Fire.jpg";
